package jp.nephy.glados.component.api.niconico

import com.rometools.rome.io.SyndFeedInput
import com.rometools.rome.io.XmlReader
import com.sedmelluq.discord.lavaplayer.track.AudioTrack
import jp.nephy.glados.GLaDOS
import jp.nephy.glados.component.api.niconico.model.Ranking
...
import jp.nephy.glados.component.api.niconico.param.SearchTarget
...
class NiconicoClient {
    ...
    private val headers = Headers.Builder()
            .add("User-Agent", "GLaDOS-bot/${GLaDOS.version} (Contact: admin@nephy.jp)")
            .build()
