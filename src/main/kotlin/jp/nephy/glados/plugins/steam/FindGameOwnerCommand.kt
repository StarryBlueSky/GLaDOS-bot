...
object FindGameOwnerCommand: Plugin() {
    @Command(channelType = Command.TargetChannelType.TextChannel, description = "指定されたSteamゲームを所有しているメンバーにメンションを飛ばします。", args = ["App ID"])
    suspend fun find(event: Command.Event) {
