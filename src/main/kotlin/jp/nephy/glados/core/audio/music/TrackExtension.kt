...
private val trackTypeMap = ConcurrentHashMap<AudioTrack, TrackType>()
...
private val trackGroupIdMap = ConcurrentHashMap<AudioTrack, Long>()
...
private val youtubedlCacheMap = ConcurrentHashMap<AudioTrack, YouTubeDL>()
...
private val soundCloudCacheMap = ConcurrentHashMap<AudioTrack, Collection>()
...
private val nicoCacheMap = ConcurrentHashMap<AudioTrack, SearchData>()
...
private val nicoRankingCacheMap = ConcurrentHashMap<AudioTrack, Video>()
...
private val youtubeCacheMap = ConcurrentHashMap<AudioTrack, com.google.api.services.youtube.model.SearchResult>()
