package jp.nephy.glados.core.audio.player.api.youtube
...
class YouTubeClient(private val apiKey: String) {
    private val api = YouTube.Builder(NetHttpTransport(), JacksonFactory(), HttpRequestInitializer { }).setApplicationName("GLaDOS").build()
