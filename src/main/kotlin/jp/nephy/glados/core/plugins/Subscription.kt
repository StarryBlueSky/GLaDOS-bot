...
object Subscription {
    ...
    object Web {
        ...
        class Session(annotation: Plugin.Web.Session, instance: Plugin, function: KFunction<*>): Element<Plugin.Web.Session>(annotation, instance, function) {
            val sessionClass: KClass<*>
                get() = annotation.sessionClass
