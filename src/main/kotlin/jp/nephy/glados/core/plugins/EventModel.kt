...
interface EventModel {
    ...
    @FromTweetstorm
    suspend fun onTweetstormAnyEvent(event: Plugin.Tweetstorm.StreamEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormAnyStatusEvent(event: Plugin.Tweetstorm.StreamStatusEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormFavorite(event: Plugin.Tweetstorm.FavoriteEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormUnfavorite(event: Plugin.Tweetstorm.UnfavoriteEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormFavoritedRetweet(event: Plugin.Tweetstorm.FavoritedRetweetEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormRetweetedRetweet(event: Plugin.Tweetstorm.RetweetedRetweetEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormQuotedTweet(event: Plugin.Tweetstorm.QuotedTweetEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormAnyUserEvent(event: Plugin.Tweetstorm.StreamUserEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormFollow(event: Plugin.Tweetstorm.FollowEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormUnfollow(event: Plugin.Tweetstorm.UnfollowEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormMute(event: Plugin.Tweetstorm.MuteEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormUnmute(event: Plugin.Tweetstorm.UnmuteEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormBlock(event: Plugin.Tweetstorm.BlockEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormUnblock(event: Plugin.Tweetstorm.UnblockEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormUserUpdate(event: Plugin.Tweetstorm.UserUpdateEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormAnyListEvent(event: Plugin.Tweetstorm.StreamListEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListCreated(event: Plugin.Tweetstorm.ListCreatedEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListDestroyed(event: Plugin.Tweetstorm.ListDestroyedEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListMemberAdded(event: Plugin.Tweetstorm.ListMemberAddedEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListMemberRemoved(event: Plugin.Tweetstorm.ListMemberRemovedEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListUpdated(event: Plugin.Tweetstorm.ListUpdatedEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListUserSubscribed(event: Plugin.Tweetstorm.ListUserSubscribedEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormListUserUnsubscribed(event: Plugin.Tweetstorm.ListUserUnsubscribedEvent) {
    }
    ...
    @FromTweetstorm
    suspend fun onTweetstormDisconnectMessage(event: Plugin.Tweetstorm.DisconnectMessageEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormLimit(event: Plugin.Tweetstorm.LimitEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormScrubGeo(event: Plugin.Tweetstorm.ScrubGeoEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormStatusWithheld(event: Plugin.Tweetstorm.StatusWithheldEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormUserWithheld(event: Plugin.Tweetstorm.UserWithheldEvent) {
    }

    @FromTweetstorm
    suspend fun onTweetstormWarning(event: Plugin.Tweetstorm.WarningEvent) {
    }
