...
data class ListPrompt<T>(val items: List<T>, val itemTitle: (T) -> String, val itemDescription: (T) -> String?, val defaultItem: T?, val title: String?, val authorName: String?, val authorUrl: String?, val authorImageUrl: String?, val description: String?, val color: HexColor?, val timeoutSecs: Long?) {
    ...
    companion object {
        private val logger = SlackLogger("GLaDOS.Message.ListPrompt")
