...
data class PageMeta(
    ...
    class Builder {
        ...
        fun build(): PageMeta {
            return PageMeta(
                openGraphType, title, description, author, email, siteName, OpenGraph.Locale(locale, alternateLocale), determiner, favicon, images, audios, videos, song, album, playlist, movie, episode, tvShow, videoOther, article, book, profile,
                twitterCardType, twitterCardSite, twitterCardCreator
            )
        }
    }
}
